(function() {
  ...
  createRun = function(options) {
    var ciBuildId, git, group, makeRequest, parallel, platform, projectId, recordKey, specPattern, specs;
    if (options == null) {
      options = {};
    }
    _.defaults(options, {
    ...
    return api.retryWithBackoff(makeRequest, {
      ...
      var browserName, browserVersion, code, osName, osVersion, payload, ref, runUrl;
